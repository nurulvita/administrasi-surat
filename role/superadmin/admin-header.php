        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../../view/superadmin/">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="../../view/superadmin/suratmasuk.php">Surat Masuk</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="../../view/superadmin/suratkeluar.php">Surat Keluar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="../../view/superadmin/suratacc.php">Permintaan Upload</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="../../view/superadmin/sekretaris.php">Kelola Sekretaris</a>
                    </li>
                </ul>
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
