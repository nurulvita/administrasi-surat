        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="suratmasuk/index.php">Surat Masuk</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="suratkeluar/index.php">Surat Keluar</a>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <span class="nav-link active">Your Email: <?=$_SESSION['email'];?></span>
                    </li>
                </ul>
            </div>
        </div>
