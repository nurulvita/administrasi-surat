                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    <h4 class="card-title mr-5">Data Sekretaris</h4>
                                </div>
                                <div class="ml-auto">
                                    <a href="sekretaris/unggah.php" class="btn btn-primary">Tambah</a>
                                </div>
                            </div>
                                <div class="container container-fluid">
                                    <div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <!-- Tombol Lihat -->
                                                                <a href="sekretaris/lihat.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Lihat</a>
                                                                <!-- Tombol Hapus -->
                                                                <a href="sekretaris/delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Hapus</a>
                                                                <!-- Tombol Edit -->
                                                                <a href="sekretaris/edit.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a>
                                                            </td>
                                                        </tr>
                                                        <?php 
                                                    }
